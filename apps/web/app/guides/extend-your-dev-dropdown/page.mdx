...
**\<DevTools/>** was created thinking about extention, so you can extend it with your own components and devtools.

On this guide, we will show you how to extend the \<DevTools/> to add a dev bypass feature for role based authentication.
...
Then you can update your layout to replace the default \<DevTools/> with your custom one:
